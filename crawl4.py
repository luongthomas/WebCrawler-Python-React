...
##
## redirects
## check your debugging: is it all fixed?
##comments and attribution
##write up, including debugging
        ...
        if tag == 'a':
            for (key, value) in attrs:
                if (key == 'href') and (value != "javascript: void 0;") and (value != "javascript:void(0)"):
                    # We are grabbing the new URL. We are also adding the base URL to it. For example:
                    # www.netinstructions.com is the base and somepage.html is the new URL (a relative URL)
                    # We combine a relative URL with the base URL to create an absolute URL like:
...
# Credit: http://www.netinstructions.com/how-to-make-a-web-crawler-in-under-50-lines-of-python-code/ 
...
# #BFS
# traversalDict = breadthSpider("https://www.ics.uci.edu/~eppstein/161/960215.html", "coil", 5)
# traversalDict = breadthSpider("https://myaccount.nytimes.com/mem/purchase/gateway/checkout.html?OC=20000066020", "coil", 5)
# traversalDict = breadthSpider("https://www.reddit.com/r/personalfinance/", "coil", 5)
traversalDict = breadthSpider("http://cn.nytimes.com", "coil", 5)

#DFS
# traversalDict = depthSpider("https://www.reddit.com/r/personalfinance/", "coil", 5)
# traversalDict = depthSpider("https://www.ics.uci.edu/~eppstein/161/960215.html", "coil", 5)
